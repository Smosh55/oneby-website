...
// A/B variant hero: organization-first framing (vs. the AI-flow framing in
// Hero.tsx). Everything below the headline/subcopy is intentionally identical
// to Hero so the test isolates positioning, not offer or layout.
    ...
    <section id="top" className="relative overflow-hidden pt-28 pb-16 lg:pt-32 lg:pb-24">
      ...
      <div className="container-x">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            Run your whole shop{" "}
            <span className="text-gradient">from one screen.</span>
          </h1>
          ...
          >
            Calls, jobs, schedule, customers, and invoices, all in one place.
            Everyone sees what&apos;s next, and nothing falls through the cracks,
            so you can stop juggling apps and run the work.
          </p>
