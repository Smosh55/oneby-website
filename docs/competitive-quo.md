...
| 5 | **Price anchor in the hero**: "Founders pricing from $29/mo — locked for life" in the homepage hero and every trade hero, next to the waitlist CTA. Quo proves the anchor belongs in the hero. | Low | Conversion — removes price anxiety at first touch, strengthens founders urgency |
